...
function HeroSection() {
  const heroImages: HeroImage[] = useMemo(
    () => [
      {
    src: "/images/retail/Luxury-retail-space.webp",
...
function SignatureProjects() {
  const slide = {
  img: "/images/retail/luxe-boutique-interior.webp",
  title: "Luxe Boutique Flagship",
  desc: "A curated shopping experience blending brand identity with immersive interior design.",
  alt: "Interior view of Luxe Boutique Flagship showcasing luxurious design and immersive shopping experience"
  };
  ...
  return (
    <section className="py-24 bg-black text-white px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-400">— Luxury Retail Brand, Abu Dhabi.</p>
      </div>
    </section>
  );
}
...
function FinalCTA() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(17,17,17,0.5), rgba(0,0,0,0.5)), url('/images/retail/retail-flagship.png')",
      }}
  ...
  <span
    className="sr-only"
    role="img"
    aria-label="Interior of a retail flagship store showcasing modern design and luxurious displays"
  />
...
export default function RetailInteriors() {
  return (
    <>
      <Head>
  <title>Duqor Retail Interior Design | Luxury Brand Experiences</title>
  <meta
    name="description"
