    ...
    <section className="py-24 bg-black text-white text-center px-6">
      ...
      >
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
          At <span style={{ color: GOLD }}>Duqor</span>, we create ambiences that captivate — from boutique hotels to luxury restaurants. Every curve, color, and contour is designed to evoke comfort, sophistication, and a sense of belonging.
        </p>
      </motion.div>
