      ...
      <section className="bg-[#0a0a0a] text-white overflow-hidden">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6">
          ...
          <div className="relative z-30 max-w-3xl mt-20 sm:mt-32">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-12 font-light text-gray-200">
        ...
        <div className="py-24 px-4 sm:px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              Every Duqor project begins with a vision — to blend form and function in perfect harmony.
            </p>
            <p className="text-gray-300 leading-relaxed">
              Our process is rooted in collaboration, creativity, and attention to detail.
            </p>
          </div>
        </div>
        ...
        <div className="py-24 bg-[#111]">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10 px-4 sm:px-6">
            {[
              { title: "Residential Design", desc: "Crafting intimate, luxurious living spaces.", img: "/images/portfolio/project-2/pic-1.png" },
              { title: "Commercial Design", desc: "Workspaces that inspire productivity.", img: "/images/portfolio/project-1/pic-5.png" },
              { title: "Hospitality Design", desc: "Immersive environments with comfort.", img: "/images/portfolio/hospitality/project-3/pic-2.png" },
              { title: "Retail Design", desc: "Retail experiences that elevate brands.", img: "/images/portfolio/retail/project-1/pic-1.png" },
            ].map((item, i) => (
              <div
                key={i}
                className="rounded-2xl overflow-hidden border border-[#2c2c2c] bg-[#0d0d0d] hover:border-[#c38a27]/50 transition-all group"
              >
        ...
        <section className="py-28 bg-[#0a0a0a] text-white px-6" id="contact-form">
          <div className="text-center mb-14">
            <h2 className="text-4xl md:text-5xl font-bold">
              Let’s <span className="bg-clip-text text-transparent bg-linear-to-r from-[#e7c675] via-[#c38a27] to-[#8b5b10]">Discuss</span> Your Project
            </h2>
            ...
            >
              ...
              <div className="space-y-4 grow">
                <div>
                  ...
                  <input type="text" name="name" required className="w-full p-3 bg-[#0d0d0d] border border-[#333] rounded-lg" />
                </div>

                <div>
                  <label className="block text-gray-300 mb-1">Email *</label>
                  <input type="email" name="email" required className="w-full p-3 bg-[#0d0d0d] border border-[#333] rounded-lg" />
                </div>

                <div>
                  <label className="block text-gray-300 mb-1">Phone *</label>
                  <input type="tel" name="phone" placeholder="+971 50 000 0000" required className="w-full p-3 bg-[#0d0d0d] border border-[#333] rounded-lg" />
                </div>

                <div>
                  <label className="block text-gray-300 mb-1">Message</label>
                  <textarea name="message" rows={5} required className="w-full p-3 bg-[#0d0d0d] border border-[#333] rounded-lg resize-none"></textarea>
                </div>
              </div>

              <button type="submit" className="w-full py-3 bg-[#c38a27] text-black rounded-full font-semibold cursor-pointer">
                Send Message
              </button>
            </form>
          </div>
        ...
        {/* ---------------- CTA ---------------- */}
        <div
          className="relative text-center py-28 sm:py-32 bg-cover bg-center px-4 sm:px-6"
          style={{
            backgroundImage:
