      ...
      <section className="min-h-screen relative bg-linear-to-b from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto mb-16"
          >
            ...
            aesthetics. We deliver end-to-end solutions across residential, commercial, retail, and hospitality sectors throughout the UAE and GCC.
          </motion.p>
            ...
            {highlights.map((item, i) => (
              <motion.div
                ...
                className="bg-linear-to-br from-[#1e1e1e] via-[#2a2a2a] to-[#151515] 
                           ...
                           rounded-2xl p-5 shadow-md hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] 
                           transition-transform duration-300 flex flex-col text-left"
              >
                <div className="flex items-start gap-3">
                  ...
                  <motion.div
                    ...
                    className="w-3 h-3 rounded-full bg-[#d4af37] shrink-0 mt-1"
                    aria-hidden="true"
                  />
                  <p className="text-gray-200 font-medium text-sm sm:text-base">{item}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
