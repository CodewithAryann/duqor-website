      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-30 flex flex-col items-center justify-center h-full text-center text-white px-6">
          ...
          >
            ...
            <Link href="/portfolio">
              <button className="relative overflow-hidden px-10 py-3 rounded-full font-serif font-semibold text-lg tracking-wide text-black
                 bg-linear-to-b cursor-pointer from-[#f5d67a] via-[#c38a27] to-[#8b5b10]
            ...
            <Link href="/contact">
              <button className="relative overflow-hidden px-10 py-3 rounded-full font-serif font-semibold text-lg tracking-wide text-black
                 ...
                 border-2 cursor-pointer border-[#c38a27]
